...
AC_CONSUMPTION: pd.DataFrame = pd.read_csv("https://raw.githubusercontent.com/nick-gibb/meteohack/master/data/ac_consumption/010_Data_Donn%C3%A9es.csv", encoding='windows-1252')
...
def get_dataset_for_climate_model(model: str):
    ...
    if model not in _CDD_DATA:
        ...
        _CDD_DATA[model] = Dataset(rf'/home/gibbnick/meteohack/data/cdd_rcp{model}_ens-pct50_1951-2100.nc')
        # _CDD_DATA[model] = Dataset(rf'cdd_rcp{model}_ens-pct50_1951-2100.nc')
...
_DESIGN_TEMP_STATIONS = pd.read_csv('https://raw.githubusercontent.com/nick-gibb/meteohack/master/data/records_df.csv')
